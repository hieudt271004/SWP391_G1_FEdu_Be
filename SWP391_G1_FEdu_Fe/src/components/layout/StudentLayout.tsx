...
import { Home, BookOpen, Upload, Settings, GraduationCap, Calendar, Menu, Sun, Moon } from 'lucide-react';
      ...
      <div className="p-4 border-b border-sidebar-border">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-[10px] text-muted-foreground">Student Portal</div>
          </div>
        </div>
      </div>
...
export function StudentLayout() {
  ...
  const isLearnMode = location.pathname.includes('/learning-path') && searchParams.get('mode') === 'learn';
